...
% SLIDE 4: AGENDA PEMBELAJARAN (FIX #9: Alokasi Waktu)
\begin{frame}{Agenda Pembelajaran (Outline Materi)}
    ...
    \vspace{0.15cm}
    \centering
    \scriptsize \textit{Total durasi fasilitasi: $\pm$80 menit (termasuk 2 sesi workshop praktik)}
\end{frame}

% SLIDE 5: GLOSARIUM RINGKAS (FIX #7: Istilah Teknis)
...
% SLIDE 7: PROBLEM QUANTIFICATION
...
% SLIDE 8: THE GAP (Friction Points)
...
% SLIDE 10: POLLING INTERAKTIF (FIX #6: Jeda Interaktif Antar Teori)
\begin{frame}{Refleksi Cepat: Diagnosa Awal Unit Anda}
    \vspace{0.3cm}
    \begin{premiumbox}[Polling Peserta]
        \large
        \centering
        \textit{``Dari 7 domain PARBICA, di domain mana unit kerja Anda merasa \textbf{paling lemah}?''}
    \end{premiumbox}
    \vspace{0.3cm}
    \begin{columns}[T]
        \column{0.48\textwidth}
...
% SLIDE 11: THEORY - CONTINUUM MODEL
    ...
    \begin{columns}
        ...
        \begin{premiumbox}[Pergeseran Paradigma (Frank Upward, 1996)]
            ...
            \begin{itemize}
                ...
                \item \textbf{Organize:} Integritas dan interoperabilitas terjamin sejak rancangan awal (\textit{by design}).
                \item \textbf{Pluralize:} Bukti akuntabilitas institusional yang dapat diakses lintas batas.
            \end{itemize}
        \end{premiumbox}
        
        \column{0.45\textwidth}
        \begin{orangebox}[Relevansi Kritis bagi PLN]
            \small Tata kelola arsip PLN tidak lagi beroperasi secara pasif sebagai fungsi administratif di area \textit{back-end}, melainkan ditanamkan secara terintegrasi (\textit{embedded}) pada aplikasi operasional lini depan (\textit{front-end}).
        \end{orangebox}
    \end{columns}
\end{frame}

% SLIDE 12: THEORY - GOVERNANCE & ISO
...
% SLIDE 15: AS-IS BPMN (FIX #8: Justifikasi BPMN untuk MA)
...
% ================================================================
%  BAGIAN II: DESAIN & IMPLEMENTASI (BAB 3--4) --- 35 Menit
% ================================================================
...
% SLIDE 18: PATTERNS OF INTEGRATION
...
% SLIDE 19: STUDI KASUS ALTERNATIF (FIX #4: BAST Pengadaan)
...
% SLIDE 21: WORKSHOP 1 (FIX #3: Aktivitas Workshop)
...
% SLIDE 24: METADATA EVIDENCE FRAMEWORK
...
\begin{frame}{Metodologi Pengukuran: \textit{Time-Cost-Risk Saving}}
    ...
    \begin{columns}[T]
        ...
        \begin{premiumbox}[Kerangka Trifecta]
            \scriptsize
            \begin{description}
                \item[\textcolor{plnblue}{Time Saving}] Pemangkasan waktu tunggu \& durasi proses. Meningkatkan agilitas respons terhadap auditor.
                \item[\textcolor{plnorange}{Cost Saving}] Reduksi pengeluaran riil (kertas, cetak, gudang) serta biaya kerja ulang akibat kesalahan manual.
                \item[\textcolor{plngreen}{Risk Saving}] Perlindungan terhadap kerugian finansial masif akibat kehilangan arsip vital atau sanksi hukum.
            \end{description}
        \end{premiumbox}
        ...
        \begin{orangebox}[Formula ROI]
            ...
            $\Delta$Waktu $\times$ Volume $\times$ Biaya/Jam\\[0.2cm]
            \textbf{Cost Avoidance:}\\
            Eliminasi cetak ulang, kirim ulang, sewa gudang.\\[0.2cm]
...
\begin{frame}{4 Indikator Kinerja Utama (KPI)}
    ...
    \begin{premiumbox}[Kriteria Kepatuhan]
        \tiny
        \textbf{Arsip Digital:} Audit trail utuh, TTE tersertifikasi, \textit{immutable} (hash), 12 metadata otomatis, \textit{single source of truth}. \quad
        \textbf{Arsip Hibrida:} Sinkronisasi lokasi fisik-digital, label retensi selaras JRA, log mutasi fisik tercatat.
    \end{premiumbox}
\end{frame}

% SLIDE 28: STUDI KASUS - BEFORE
...
\begin{frame}{Analisis ROI: Investasi vs Manfaat}
    ...
    \end{premiumbox}
    \vspace{0.1cm}
    {\tiny\itshape\textcolor{gray}{*Angka merupakan asumsi pemodelan pedagogis. Peserta wajib mengganti parameter dengan data faktual unit kerja saat menyusun Business Case.}}
\end{frame}
...
% SLIDE 37: REFLEKSI & KOMITMEN (FIX #5)
...
% SLIDE 38: CLOSING (FIX #10: Penutup Bermakna)
