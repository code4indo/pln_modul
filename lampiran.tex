...
C & Draft SOP Digital & SOP 7 komponen lengkap + peer review & 15 menit & 25\% \\
...
\begin{enumerate}
    ...
    \item \textbf{Lampiran C} -- Susun SOP digital 7 komponen untuk mengatur alur kerja baru tersebut.
...
\begin{instruksibox}
\begin{enumerate}
    \item Isi \textbf{ketujuh komponen SOP} untuk 1 proses kearsipan PLN yang telah dirancang di Bab 3.
