...
\begin{enumerate}[nosep, leftmargin=*]
    ...
    \item Tandai setiap trigger otomatis dengan warna/arsir berbeda.
...
% Komponen 4
\begin{tcolorbox}[colback=plnblue!3, colframe=plnblue!50, sharp corners, title={\small\bfseries Komponen 4: System Trigger \& Metadata Wajib}]
\noindent\textbf{Trigger Event:} \fillline[10cm]\\[0.3cm]
...
Penghematan cycle time: & Rp \fillline[4cm] /tahun \\[0.3cm]
