...
\hspace*{1.5cm} 3.2 Pemodelan Alur Kerja dengan BPMN 2.0 \dotfill \\
...
\hspace*{1.5cm} 4.2 Komponen Wajib SOP Terintegrasi (Pemetaan Format Korporat) \dotfill \\
\hspace*{1.5cm} 4.3 Standar Metadata Wajib Terintegrasi \dotfill \\
\hspace*{1.5cm} 4.4 Penyelarasan Regulasi \& Tata Kelola BUMN (Fokus PP 71/2019) \dotfill \\
\hspace*{1.5cm} 4.5 Review \& Finalisasi SOP \dotfill \\[0.2cm]

{\large\bfseries BAB 5 \quad PENGHITUNGAN EFISIENSI \& ROI} \dotfill \textbf{Buku 3} \\
\hspace*{1.5cm} 5.1 Metodologi Pengukuran Kinerja Kearsipan \dotfill \\
\hspace*{1.5cm} 5.2 Indikator Kinerja Utama (KPI) \dotfill \\
\hspace*{1.5cm} 5.3 Metode Penghitungan Efisiensi \& ROI \dotfill \\
\hspace*{1.5cm} 5.4 Studi Kasus Menyeluruh: Transformasi SPK Pemeliharaan GI 150 kV \dotfill \\
\hspace*{1.5cm} 5.5 Penyusunan Justifikasi Bisnis \& Rencana Aksi \dotfill \\[0.2cm]
...
\begin{enumerate}[leftmargin=*]
    \item \textbf{\textit{Document Shadowing} (Penelusuran Fisik/Digital):} Jadikan satu dokumen nyata sebagai objek pelacakan (contoh: melacak nomor tiket arsip perintah kerja (SPK) 1445 dari sejak tiket dibuka, dicetak, ditandatangani, hingga masuk di berkas arsip). Catat setiap hambatan maupun waktu transisinya.
...
\begin{enumerate}[leftmargin=*]
    ...
    \end{itemize}
    \item \textbf{Tandai Hambatan Operasional (\textit{Friction Points}):}
    \begin{itemize}[nosep]
