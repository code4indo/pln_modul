...
\textbf{4.2} & Desain arsitektur teknis terintegrasi & Blueprint integrasi $\rightarrow$ acuan trigger di 4.3.2 \\
...
Bab 3 & Perancangan alur kerja terintegrasi (To-Be) & 20 menit & Diagram BPMN 2.0 + Peta Trigger \\
...
\begin{enumerate}[leftmargin=*]
    ...
    \begin{itemize}[nosep]
        ...
        \item Diagram BPMN 2.0 (To-Be) + Peta Trigger (Bab 3)
...
Perancangan \textbf{trigger otomasi \& routing digital} & Pemilihan platform EDMS atau spesifikasi teknis server \\
...
4.1 & Apakah sistem operasional memiliki kemampuan trigger otomatis ke repositori arsip? & Teknologi & $\square$ \\
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Skor 3 (Siap Parsial):} Dapat dioptimalkan melalui perumusan \textit{trigger} digital, SLA, dan \textit{exception handling}.
...
% Total cycle time
\node[below=1.4cm of s4, font=\small\bfseries, text=red!70!black] {Total Cycle Time: 3--5 Hari Kerja};
% Legend
...
\midrule
1 & Input data arsip & Duplikasi input manual dari 2 sistem & Trigger otomatis dari Sistem ERP & Tinggi \\
