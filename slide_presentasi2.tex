...
\mode<presentation>{
    ...
    \usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{assets/content.png}}
...
\AtBeginSection[]{
  {
    \usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{assets/section.png}}
    \begin{frame}[plain]
      \vfill
      \centering
...
\begin{frame}{Agenda Pembelajaran (Outline Materi)}
    ...
    \begin{columns}[T]
        \column{0.48\textwidth}
        \begin{premiumbox}[Bagian I: Fondasi \& Diagnosa]
            \makebox[\linewidth][r]{%
                \tcbox[on line, colback=plnblue!15, colframe=plnblue, boxrule=0.6pt, arc=2pt, boxsep=1pt, left=4pt, right=4pt, top=1pt, bottom=1pt, fontupper=\bfseries\tiny\color{plnblue}]{15 menit}%
            }
            \vspace{0.1cm}
            
            \scriptsize
            \stepicon{plnblue}{1} \textbf{Pendahuluan \& Urgensi}\\
            {\scriptsize Visi Ekosistem Kearsipan Digital \& Biaya Tersembunyi Proses Manual.}\\[0.2cm]
            \stepicon{plnblue}{2} \textbf{Landasan Internasional}\\
            {\scriptsize Metodologi PARBICA, Teori \textit{Continuum}, \& Tata Kelola ISO 15489.}\\[0.2cm]
            \stepicon{plnblue}{3} \textbf{Evaluasi Prosedur Lapangan}\\
            {\scriptsize Identifikasi Titik Gesekan (\textit{Friction}) \& Pemodelan BPMN Saat Ini.}
        \end{premiumbox}
        
        \column{0.48\textwidth}
        \begin{orangebox}[Bagian II: Desain \& Implementasi]
            \makebox[\linewidth][r]{%
                \tcbox[on line, colback=plnorange!15, colframe=plnorange, boxrule=0.6pt, arc=2pt, boxsep=1pt, left=4pt, right=4pt, top=1pt, bottom=1pt, fontupper=\bfseries\tiny\color{plnorange}]{30 menit}%
            }
            \vspace{0.1cm}
            
            \scriptsize
            \stepicon{plnorange}{4} \textbf{Perancangan Alur Terintegrasi}\\
            {\scriptsize Model Target (\textit{To-Be}), Pola Otomasi, \& Workshop BPMN.}\\[0.2cm]
            \stepicon{plnorange}{5} \textbf{Penyusunan SOP Digital}\\
            {\scriptsize Struktur SOP 8 Komponen, 14 Field Metadata, \& Legalitas TTE.}\\[0.2cm]
            \stepicon{plnorange}{6} \textbf{Analisis ROI \& Tindak Lanjut}\\
            {\scriptsize KPI, Studi Kasus GI 150kV, Workshop Business Case, \& Refleksi.}
        \end{orangebox}
    \end{columns}
    \centering
    \textcolor{darkgrey}{\scriptsize \textit{Total durasi fasilitasi: $\pm$45 menit (30 menit materi + 15 menit workshop praktik)}}
\end{frame}
...
\section{Analisis ROI \& Tindak Lanjut}
...
\begin{frame}{Workshop 2: Penyusunan Business Case \& Action Plan}
    \vspace{0.1cm}
    \begin{premiumbox}[Instruksi Aktivitas Kelompok]
        \small
        \begin{enumerate}
            ...
            \item Susun \textbf{Action Plan 30 Hari} dengan Target mingguan \& penanggung jawab.
    ...
    \begin{columns}[T]
        \column{0.48\textwidth}
        \begin{orangebox}[Output Wajib, hbox]
            \scriptsize
            \begin{tabular}{@{}l@{}}
                \stepicon{plngreen}{4} \textbf{KPI Tracker + Business Case + Action Plan 30 Hari}\\
...
\begin{frame}{Metodologi ADKAR: Framework Transformasi SDM}
    \begin{columns}
        ...
        \begin{tcolorbox}[colback=white, colframe=plnblue!15, boxrule=0.5pt, arc=2pt, outer arc=2pt, left=2pt, right=2pt, top=2pt, bottom=2pt, boxsep=0pt, width=0.95\linewidth, drop shadow]
            \centering
            \includegraphics[width=0.9\linewidth,keepaspectratio]{assets/adkar.png}
        \end{tcolorbox}
