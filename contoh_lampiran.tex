...
\small
\noindent\textbf{Pemicu:} \textit{Status arsip perintah kerja (SPK) berubah ke Selesai di Sistem Operasi}\\[0.2cm]
...
Penghematan waktu siklus (1.200 arsip perintah kerja (SPK) $\times$ 4,2 hari $\times$ Rp 150.000): & Rp 756.000.000 /tahun \\[0.2cm]
