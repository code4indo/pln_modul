...
\subtitle{Modul 4.4 -- Level 4 (Mastery) -- Transformasi Tata Kelola Kearsipan\\ \textbf{PT PLN (Persero)}}
\author{}
\institute[PLN]{}
\date{}
    ...
    \begin{columns}[T]
        ...
        \begin{premiumbox}[Target Peserta]
            ...
            \begin{itemize}
                ...
                \item Unit Kearsipan, IT Governance, GCG, Risk Management.
...
\begin{frame}{Agenda Pembelajaran}
    \begin{columns}[T]
        ...
        \begin{tcolorbox}[colback=plnblue!5!white, colframe=plnblue, fonttitle=\bfseries\footnotesize, sharp corners, boxrule=0.6pt, left=2pt, right=2pt, top=0.5pt, bottom=0.5pt, title={Bagian I:\\Fondasi \& Urgensi}]
            \makebox[\linewidth][r]{%
                \tcbox[on line, colback=plnblue!15, colframe=plnblue, boxrule=0.5pt, arc=2pt, boxsep=0pt, left=2pt, right=2pt, top=0.5pt, bottom=0.5pt, fontupper=\bfseries\tiny\color{plnblue}]{10 menit}%
            }
            \scriptsize
            [ICON] \textbf{Konteks \& Urgensi}\\
            {\tiny Serangan siber, regulasi, GCG.}\\
            [ICON] \textbf{Arsitektur 4 Pilar}\\
        ...
        \begin{tcolorbox}[colback=plnorange!5!white, colframe=plnorange, fonttitle=\bfseries\footnotesize, sharp corners, boxrule=0.6pt, left=2pt, right=2pt, top=0.5pt, bottom=0.5pt, title={Bagian II:\\Empat Pilar Keamanan}]
            \makebox[\linewidth][r]{%
                \tcbox[on line, colback=plnorange!15, colframe=plnorange, boxrule=0.5pt, arc=2pt, boxsep=0pt, left=2pt, right=2pt, top=0.5pt, bottom=0.5pt, fontupper=\bfseries\tiny\color{plnorange}]{30 menit}%
            }
            \scriptsize
            [ICON] \textbf{Pilar 1: RBAC}\\
            [ICON] \textbf{Pilar 2: Audit Trail}\\
            [ICON] \textbf{Pilar 3: Kebijakan ISMS}\\
            [ICON] \textbf{Pilar 4: Backup \& DR}
        \end{tcolorbox}
        ...
        \begin{tcolorbox}[colback=plngreen!5!white, colframe=plngreen, fonttitle=\bfseries\footnotesize, sharp corners, boxrule=0.6pt, left=2pt, right=2pt, top=0.5pt, bottom=0.5pt, title={Bagian III:\\Studi Kasus \& Validasi}]
            ...
            \scriptsize
            [ICON] \textbf{Studi Kasus Integratif}\\
            {\tiny Insiden kebocoran arsip.}\\
            [ICON] \textbf{Portofolio \& Tollgate}\\
            {\tiny Rubrik, komitmen, tindak lanjut.}
        \end{tcolorbox}
    \end{columns}
    \centering
    \vspace{0.15cm}
    \textcolor{darkgrey}{\scriptsize \textit{Durasi fasilitasi: 45 menit (Pendahuluan 5$\cdot$ RBAC 10$\cdot$ Audit 10$\cdot$ ISMS 10$\cdot$ DR 7$\cdot$ Kasus 3), workshop mandiri 4$\times$30 menit}}
\end{frame}
...
\begin{frame}{Arsitektur Keamanan Terintegrasi: 4 Pilar}
    ...
    \begin{tikzpicture}[
        ...
        \node[font=\tiny, text=gray] at (2,0.5) {WHO?};
        \node[font=\tiny, text=gray] at (6,0.5) {WHEN/WHAT?};
        \node[font=\tiny, text=gray] at (10,0.5) {HOW?};
    \end{tikzpicture}
...
\begin{frame}{Diagram Alur Audit Trail Sistem Arsip Digital PLN}
    \centering
    \includegraphics[width=0.88\textwidth,keepaspectratio]{gambar/Audit_Trail_Flow_Custom.pdf}
    
    \vspace{0.2cm}
    \scriptsize
    \begin{tabularx}{\textwidth}{@{} >{\centering\arraybackslash}p{2.2cm} >{\centering\arraybackslash}p{2.2cm} >{\centering\arraybackslash}p{2.2cm} >{\centering\arraybackslash}p{2.2cm} @{}}
        \toprule
...
\begin{frame}{Langkah Perumusan Kebijakan}
    ...
    \begin{tikzpicture}[
        ...
        \node[stepbox] (s2) at (2.8,0) {Draf oleh\\Tim Lintas};
...
\begin{frame}{Business Continuity Plan (BCP): Siklus Hidup ISO 22301}
    \centering
    \includegraphics[width=0.55\textwidth,keepaspectratio]{gambar/BCP_Lifecycle_Custom.png}
    ...
    \begin{columns}[T]
        ...
        \begin{orangebox}[Pemeliharaan]
            ...
            \end{enumerate}
            \vspace{0.1cm}
            \textbf{Simulasi minimal 6 bulan sekali!}
        \end{orangebox}
    \end{columns}
\end{frame}
